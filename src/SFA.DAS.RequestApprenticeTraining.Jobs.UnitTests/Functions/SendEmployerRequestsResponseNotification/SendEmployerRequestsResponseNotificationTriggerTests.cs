...
{
    public class SendEmployerRequestsResponseFunctionTests
    {
        [Test, MoqAutoData]
        public async Task SendEmployerRequestsResponse_Should_Send_Notification(EmployerRequestResponseEmail email)
        {
            // Arrange
